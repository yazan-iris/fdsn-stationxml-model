...
@XmlSeeAlso({
    edu.iris.station.model.Polynomial.Coefficient.class,
    edu.iris.station.model.Coefficients.Numerator.class,
    edu.iris.station.model.Coefficients.Denominator.class
})
